...
class CalendrierJuniorDAO extends AbstractDAO {
    protected static $tableName = "Matches_Ligue_Junior";
    protected static $primaryKey = "id_matches_juniors";

    protected function createObject($data) {
        return new Calendrier(
            $data['id_matches_juniors'],
            $data['date_matches_juniors'],
            $data['lieu_matches_juniors'],
    ...
    protected function getInsertFields() {
        return "date_matches_juniors, lieu_matches_juniors, nom_equipes_locales_juniors, nom_equipes_visiteuses_juniors";
    }
    ...
    public static function obtenirMatchsSansResultat() {
        try {
            ...
            $requete = $connexion->prepare(
                ...
                LEFT JOIN Resultats_Juniors r ON m.id_matches_juniors = r.id_matches_juniors 
                WHERE r.id_matches_juniors IS NULL"
            );
            $requete->execute();
