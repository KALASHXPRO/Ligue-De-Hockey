...
<head>
    ...
    <title>Ajouter un résultat junior</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Ajouter un résultat junior</h2></div>
            <div class="texte">
                <form action="?action=ajouterResultatJunior" method="post" class="form-container">
                    ...
                    <select id="idMatch" name="idMatch" required onchange="updateEquipes()">
                        ...
                        <?php 
                        $matchs = CalendrierJuniorDAO::obtenirMatchsSansResultat();
