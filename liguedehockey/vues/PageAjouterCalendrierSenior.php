...
<head>
    ...
    <title>Ajouter un match majeur</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Ajouter un match majeur</h2></div>
            <div class="texte">
                <form action="?action=ajouterCalendrierSenior" method="post" class="form-container">
