...
$equipe = $controleur->getEquipeSenior(); 
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Modifier une équipe majeure</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Modifier une équipe majeure</h2></div>
            <div class="texte">
                <form action="?action=modifierEquipeSenior" method="post" class="form-container">
