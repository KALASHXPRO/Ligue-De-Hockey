...
<head>
    ...
    <title>Le calendrier majeurs</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Le calendrier majeur</h2></div>
            <div class="texte"><p>Consultez ici le calendrier des matchs seniors.</p></div>
            <?php if (!empty($_SESSION['is_admin'])): ?>
                <a href="?action=ajouterCalendrierSenior" class="btn-add">Ajouter un match majeur</a>
            <?php endif; ?>
            <div class="CalendrierTableaux">
                <?php
                include_once "/vues/inclusions/fonctions.inc.php";
                afficherTableCalendriersSenior($controleur->getTabCalendrierSenior(), !empty($_SESSION['is_admin']));
                ?>
            </div>
        </main>
    </div>
