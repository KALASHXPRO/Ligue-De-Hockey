...
<head>
    ...
    <title>Les résultats majeurs</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Les résultats majeurs</h2></div>
            <div class="texte"><p>Consultez ici les résultats des matchs seniors.</p></div>
            <?php if (!empty($_SESSION['is_admin'])): ?>
                <a href="?action=ajouterResultatSenior" class="btn-add">Ajouter un résultat majeur</a>
            <?php endif; ?>
            <div class="ResultatsTableaux">
                <?php
                include_once "/vues/inclusions/fonctions.inc.php";
                afficherTableResultatsSenior($controleur->getTabResultatsSenior(), !empty($_SESSION['is_admin']));
                ?>
            </div>
        </main>
    </div>
