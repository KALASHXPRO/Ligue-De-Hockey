...
<head>
    ...
    <title>Les équipes juniors</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Les équipes juniors</h2></div>
            <div class="texte"><p>Retrouvez ici toutes les informations sur nos équipes juniors.</p></div>
            <?php if (!empty($_SESSION['is_admin'])): ?>
                <a href="?action=ajouterEquipeJunior" class="btn-add">Ajouter une équipe junior</a>
            <?php endif; ?>
            <div class="Équipes">
                <?php
                include_once "/vues/inclusions/fonctions.inc.php";
                afficherTableEquipesJunior($controleur->getTabEquipesJunior(), !empty($_SESSION['is_admin']));
                ?>
            </div>
        </main>
    </div>
