...
<head>
    ...
    <title>Ajouter une équipe junior</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Ajouter une équipe junior</h2></div>
            <div class="texte">
                <form action="?action=ajouterEquipeJunior" method="post" class="form-container">
