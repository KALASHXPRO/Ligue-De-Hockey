...
$calendrier = $controleur->getCalendrierSenior();
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Modifier un match majeur</title>
</head>
<body>
    <header>
    ...
    <nav id="menu-horizontal">
        <ul>
            ...
            <li><a href="?action=voirResultatsSenior">Les résultats majeures</a></li>
            <li><a href="?action=voirResultatsJunior">Les résultats juniors</a></li>
            <li><a href="?action=voirCalendrierSenior">Le calendrier majeures</a></li>
            <li><a href="?action=voirCalendrierJunior">Le calendrier juniors</a></li>
        </ul>
    </nav>
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Modifier un match majeur</h2></div>
            <div class="texte">
                <form action="?action=modifierCalendrierSenior" method="post" class="form-container">
