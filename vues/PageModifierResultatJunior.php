...
$resultat = $controleur->getResultatJunior();
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Modifier un résultat junior</title>
</head>
<body>
    <header>
    ...
    <div class="corps">
        <main class="main-content">
            <div class="apropos"><h2>Modifier un résultat junior</h2></div>
            <div class="texte">
                <form action="?action=modifierResultatJunior" method="post" class="form-container">
