...
CREATE USER 'Administrateurs'@'localhost' IDENTIFIED BY 'ProjectW';
GRANT ALL PRIVILEGES ON LigueHockeyDB.* to 'Administrateurs'@'localhost' with GRANT OPTION;
FLUSH PRIVILEGES;